...
//Values of cards follow Black Jack rules where number cards are thier corresponding 
//number, face cards are ten, and ace can be either eleven or 1 but starts with a value of 11
...
class Card {
    ...
    //Returns array instead of string so that mulitple cards can be displayed beside 
    //each other later on
    show() {
        switch(this._suit) {
            case 'hearts': 
...
export default {Card, blackJackDeck};